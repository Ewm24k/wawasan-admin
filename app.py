...
def risik_tokoh():
    ...
    # 100% exact integration of your strict 6-step prompt protocol AND Langkah 3A & Critical Rules
    system_prompt = (
        ...
        "Jangan hanya menyemak sama ada individu tersebut masih bersama pemimpin atau telah dipecat.\n"
        "Sebaliknya, sahkan semua perkara berikut:\n"
        "1. Status Individu:\n"
        ...
        "7. Tahap Kepastian:\n"
        "   Bagi setiap individu, nyatakan:\n"
        "   Status Pengesahan: Disahkan / Sebahagian Disahkan / Tidak Dapat Disahkan\n"
        "   Tahap Keyakinan: Tinggi / Sederhana / Rendah\n\n"
        "## Peraturan Kritikal\n"
        ...
        "Sebaliknya, AI MESTI mengesahkan:\n"
        "- Di mana individu itu berada sekarang.\n"
        "- Jawatan rasmi mereka sekarang.\n"
        "- Organisasi atau parti yang mereka sertai sekarang.\n"
        "- Sama ada mereka masih mempunyai hubungan aktif dengan pemimpin yang sedang dianalisis.\n"
        "- Bukti bertarikh yang menyokong kesimpulan tersebut.\n"
        "Jika mana-mana maklumat di atas tidak dapat disahkan, AI hendaklah menyatakannya dengan jelas dan tidak membuat andaian.\n\n"
